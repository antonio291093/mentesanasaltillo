...
if (!process.env.TEST_ENV) {
    throw new Error(
        ...
        'Example: TEST_ENV=local npx playwright test\n' +
        'Valid values depend on your .env.{env} files (e.g., local, dev, test, production).\n\n' +
...
/** Returns admin login credentials for the active environment. */
...
/** Returns the path to the admin auth state file. */
export function getAdminAuthFilePath(): string {
    return requireEnv('ADMIN_AUTH_FILE');
}
